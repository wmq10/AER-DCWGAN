...
from generative import GenerativeScores
import os
...
def main():
    ...
    for attack_idx, attack_name in enumerate(all_attacks):
        ...
        print(f"\n ({attack_idx + 1}/{len(all_attacks)}): {attack_name}")
        ...
        try:
            reshaped_X = X_scaled.reshape(-1, 1, 4, 6)  #
        ...
        if num_to_generate > 0:
            ...
            generated_denorm = generated_samples.reshape(-1, 24)
        else:
